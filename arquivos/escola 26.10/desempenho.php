        ...
        if ($resultado->num_rows === 1)
         {
            ...
            if ($senha === $senha_database)
            {
               if ($nota === 'matematica p1')
               {
                ...
                $sqlnotas = "SELECT AVG(N1) AS media FROM alunos";
               ...
               if ($nota === 'matematica p2')
               {
                ...
                $sqlnotas = "SELECT AVG(N2) AS media FROM alunos";
               ...
               if ($nota === 'matematica extra')
               {
                ...
                $sqlnotas = "SELECT AVG(N3) AS media FROM alunos";
               ...
               if ($nota === 'portugues p1')
               {
                ...
                $sqlnotas = "SELECT AVG(N5) AS media FROM alunos";
               ...
               if ($nota === 'portugues p2')
               {
                ...
                $sqlnotas = "SELECT AVG(N6) AS media FROM alunos";
               ...
               if ($nota === 'portugues extra')
               {
                ...
                $sqlnotas = "SELECT AVG(N7) AS media FROM alunos";
